    ...
    */
    ...
    if($bandera){
		...
		try {
			...
			$mail->Host       = 'mail.estudiocontablesotelo.com';  // Specify main and backup SMTP servers
			$mail->SMTPAuth   = true;                                   // Enable SMTP authentication
			$mail->Username   = '_mainaccount@estudiocontablesotelo.com';                     // SMTP username
			$mail->Password   = 'kCFf#hm962T:E6';                               // SMTP password
            ...
            $mail->setFrom('estudiocontablesotelo1979@gmail.com', 'Asesoramiento - Contacto');
            $mail->addAddress('estudiocontablesotelo1979@gmail.com', '');
